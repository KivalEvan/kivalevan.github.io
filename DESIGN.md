...
Interior openings and content sections prepare before paint, then assemble once through a 560ms jagged reveal without opacity fading. Ten authored keyframes use hard snaps, with each entrance pose held for 56–67ms. Entrance and exit contours change in place, without directional travel or added jitter.
